...
void setup() {
  ...
  xTaskCreate(Temperatura,  "Temperatura",  128,  NULL ,  2 ,  NULL );
  xTaskCreate(Button ,  "Button",  128 ,  NULL,  1 ,  NULL );
  xTaskCreate(Afisare ,  "Afisare",  128 ,  NULL,  0 ,  NULL );
